...
const UserButton = async () => {
  ...
  //Mostra apenas a inicial do nome do client
        ...
        <DropdownMenuContent className="w-56" align="end" forceMount>
          <DropdownMenuLabel className="font-normal">
            <div className="flex flex-col space-y-1">
              <div className="text-sm font-medium leading-nonw">
                {session.user?.name}
              </div>
              <div className="text-sm text-muted-foreground leading-nonw">
                {session.user?.email}
              </div>
            </div>
          </DropdownMenuLabel>
